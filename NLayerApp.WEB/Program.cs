...
builder.Services.AddScoped<IMazeBuildService, MazeBuildService>();

builder.Services.AddScoped<ICellsBuildService>(container =>
new CellsBuildService(container.GetService<IMazeBuildService>())
);
